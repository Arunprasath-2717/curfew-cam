                        ...
                        children: [
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            items: [
                              ...
                              'FOOD TECH', 'AGRI'
                            ].map((dept) => DropdownMenuItem(value: dept, child: Text(dept, style: AppTextStyles.bodyMain))).toList(),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<int>(
                            ...
                            items: [1, 2, 3, 4].map((y) => DropdownMenuItem(value: y, child: Text('Year $y', style: AppTextStyles.bodyMain))).toList(),
